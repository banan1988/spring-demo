...
//    agent any
        ...
        stage("Release") {
            ...
            steps {
                ...
                script {
                    ...
                    slackNotification('SUCCESS', "Released ${env.CURRENT_VERSION} version")
                }
            }
        }
        ...
        stage("Publish") {
            ...
            steps {
                ...
                script {
                    ...
                    slackNotification('SUCCESS', "Published ${env.CURRENT_VERSION} version")
                }
            }
        }
    }
    ...
    post {
        ...
        unstable {
            slackNotification('WARN', "Unstable !")
        }
        failure {
            slackNotification('ERROR', "Failed !")
        }
        aborted {
            slackNotification('ERROR', "Aborted !")
        }
        always {
            echo "Archive JARs:"
...
def slackNotification(String level, String msg) {
    ...
    slackSend channel: 'jenkins', color: color, message: "Build ${env.JOB_NAME}#${env.BUILD_NUMBER} [${env.FAILED_STAGE_NAME}]: ${msg}", teamDomain: 'banan1988', tokenCredentialId: '11ca9396-177f-417d-bc3c-9d65f7369f0a'
}
